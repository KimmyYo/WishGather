...
const UserPage = () => {
    ...
    return ( <
        ...
        { /* User Image */ } <
        Image style = { styles.userPageChild }
        contentFit = "cover"
        ...
        <
        Text style = { styles.userName } > { profile ? profile.name || profile.email || 'User' : 'Loading...' } <
        /Text> <
        ...
        <
        Pressable style = {
            [styles.pressable, styles.pressablePosition] }
        onPress = {
            () => navigation.navigate("UserPage4") } >
        <
        ...
        onPress = {
            () => navigation.navigate("FoodScanningPage") } >
        <
        ...
        Pressable style = { styles.button }
        onPress = {
            () => navigation.navigate("TempleHomePage") } >
        <
        ...
        Pressable style = { styles.button }
        onPress = {
            () => navigation.navigate("Welfare_HomePage") } >
        <
